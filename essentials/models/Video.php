...
class Video extends Model
{
     ...
     */
    public $table = 'godspeed_essentials_videos';
    ...
    public $belongsToMany = [
        'playlists' => [
            'GodSpeed\Essentials\Models\Playlist' , "table" => "godspeed_essentials_video_playlists"
        ]
    ];
    public $morphTo = [];
    public $morphOne = [];
...
//
     ...
     public function beforeSave()
     {
         ...
         if ($this->hasYouTubeDataAPIKey() || $this->type === "vimeo") {
             $api = \GodSpeed\Essentials\Utils\VideoMeta\Video::make($this->toArray());
             $res = $api->get();

             if ($res['status'] === \GodSpeed\Essentials\Utils\VideoMeta\Video::OK) {
                 $data = [
                     'type' => $this->type,
