...
class ImageSlider extends Model
{
     ...
     */
    public $table = 'godspeed_essentials_image_sliders';
    ...
    public $rules = [
        "label" => [
            "required", "between:3,255", "unique:godspeed_essentials_image_sliders,label"
        ],
        "navigation_control_shape" => [
    ...
    {
        return \Config::get('godspeed.essentials::animate');
    }
    ...
    {
        return \Config::get('godspeed.essentials::slideIndicatorClass')['active'];
    }

    public function getIndicatorInactiveClassOptions()
    {
        return \Config::get('godspeed.essentials::slideIndicatorClass')['inactive'];
    }

    public function getNavigationPrevIconOptions()
    {
        return \Config::get('godspeed.essentials::sliderNavigationIconClass')['prev'];
    }

    public function getNavigationNextIconOptions()
    {
        return \Config::get('godspeed.essentials::sliderNavigationIconClass')['next'];
    }
}
