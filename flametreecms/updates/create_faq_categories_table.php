...
class CreateFaqCategoriesTable extends Migration
{
    public function up()
    {
        Schema::create('godspeed_flametreecms_faq_categories', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id');
        ...
        Schema::create('godspeed_flametreecms_faq_categories_pivot', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            ...
            $table->foreign('faq_id', "godspeed_flametreecms_faq_fk")
                ->references('id')
                ->on('godspeed_flametreecms_faqs')
                ->onDelete('cascade');

            $table->foreign('faq_category_id', "godspeed_flametreecms_faq_category_fk")
                ->references('id')
                ->on('godspeed_flametreecms_faq_categories')
                ->onDelete('cascade');
        });
    }
