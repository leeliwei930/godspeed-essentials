...
class ReferralSignUp extends \RainLab\User\Components\Account
{
    ...
    public function defineProperties()
    {
        return [
            ...
            'referralCodeParam' =>  [
                'title' => "Referral Code parameter",
                'description' => "The parameter key that use to pre-fill the referral code field in sign up form",
                'type' => 'string',
                'default' => 'referral'
            ]
        ];
    ...
    {
        $referralCodeParam = $this->property('referralCodeParam');
        return request()->has($referralCodeParam);
    }

    public function getReferralCode()
    {
        if ($this->hasReferralCode()) {
            return get($this->property('referralCodeParam'));
        }
    ...
    public function onRun()
    {
        ...
        $this->urlReferralCode = $this->page['referralCode'] = $this->getReferralCode();
    }
    ...
    public function onRegister()
    {
        try {
            ...
            $referralCodeValidator = $rules['referral_code'] = [
